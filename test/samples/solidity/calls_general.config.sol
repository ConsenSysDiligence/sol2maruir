...
contract __IRTest__ {
    function main() public {
        ...
        __testCase904__(__this__);
        __testCase918__(__this__);
    }

    function __testCase843__(Calls __this__) internal {
        int32 expect_843_0 = (int32(5));
        int32 ret_843_0 = __this__.sqrt(int32(25));
        assert(ret_843_0 == expect_843_0);
    }

    function __testCase875__(Calls __this__) internal {
        int32 expect_875_0 = (int32(5));
        int32 ret_875_0 = __this__.sqrt(int32(35));
        assert(ret_875_0 == expect_875_0);
    }

    function __testCase904__(Calls __this__) internal {
        __this__.complexExpressionsNesting();
    }

    function __testCase918__(Calls __this__) internal {
