...
contract __IRTest__ {
    function main() public {
        ...
        __testCase1375__(__this__);
        __testCase1389__(__this__);
        __testCase1403__(__this__);
        __testCase1417__(__this__);
    }
    ...
    function __testCase1285__(MemoryAliasing __this__) internal {
        (uint256[4] memory expect_1285_0, uint256[4] memory expect_1285_1) = ([uint256(42), uint256(80), uint256(3), uint256(4)], [uint256(42), uint256(80), uint256(3), uint256(4)]);
        (uint256[4] memory ret_1285_0, uint256[4] memory ret_1285_1) = __this__.arraysInMemoryStructs();
        assert(keccak256(abi.encodePacked(ret_1285_0)) == keccak256(abi.encodePacked(expect_1285_0)));
        assert(keccak256(abi.encodePacked(ret_1285_1)) == keccak256(abi.encodePacked(expect_1285_1)));
    }

    function __testCase1375__(MemoryAliasing __this__) internal {
        __this__.structInMemoryStructs();
    }

    function __testCase1389__(MemoryAliasing __this__) internal {
        __this__.structsInMemoryArrays();
    }

    function __testCase1403__(MemoryAliasing __this__) internal {
        __this__.structReAssignment();
    }

    function __testCase1417__(MemoryAliasing __this__) internal {
