...
contract Test {
    ...
    function receiveTests() public {
        ...
        // non-empty calls go to fallback which fails.
    ...
    */
    ...
    function sendTests() public {
        // Another contract accepts payments with receive
        ...
        // Another contract can reject payments in receive (even if fallback would accept them)
